...
<div class="post-author d-flex p-2 <?php echo $separator ? 'border-bottom' : '';?>">
    <div class="px-2 align-self-center">
        <a href="<?php echo $model['profileUrl'];?>" title="<?php echo $model['displayname'];?>">
            <img class="rounded-circle" src="<?php echo $model['photo'];?>" alt="<?php echo $model['displayname'];?>" width="50" />
        </a>
    </div>
    <div class="p-2">
        <h5 class="mb-1">
